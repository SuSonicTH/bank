...
public class Database {
    ...
    public static void init(DataSource dataSource) throws SQLException {
        try (
            ...
            statement.execute("insert into USERS(name, salt, hash, admin) values ('barbara', '13ba68aa601f392f34c9f0e25387d99f', 'efc38ddf4f4c208e182f5d98855c3dcf', 'Y')"); //pw:dimnpw
            ...
            statement.execute("insert into ACCOUNT(name, balance) values ('maximilian', 1.96)");
            statement.execute("insert into ACCOUNT(name, balance) values ('katharina', -20)");

            statement.execute("create table TRANSACTION(id NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, name varchar(30), booking_time timestamp, description varchar(100), booking_value numeric(6,2), value_date date, state varchar(20), invoice number)");
            ...
            statement.execute("create table INVOICE(id NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, name varchar(30), booking_time timestamp, balance numeric(6,2))");
        }
    }
}
