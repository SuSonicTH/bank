...
public class Database {
    ...
    public static void init(DataSource dataSource) throws SQLException {
        try (
            ...
            statement.execute("create table ACCOUNT(name varchar(30), balance numeric(6,2))");
            ...
            statement.execute("create table TRANSACTION(name varchar(30), booking_time timestamp, description varchar(100), booking_value numeric(6,2), value_date date, state varchar(20))");
